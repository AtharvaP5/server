...
#     electivePattern = r"^\s*\((ELECTIVE \d+)\s*:\s*([A-Z\d]+)\s*:\s*([^)]+)\)"
    ...
    for i in text.splitlines():
        ...
        if match:
            ...
            print("roll no :" ,match.group(1)," name : ",name.lstrip('/'),"prn : ",match.group(3).replace(" ",""))
        ...
        #first line of marks
        flm1 = re.findall(flp1,i) #flm = first line match   #flp = first line pattern #normal
        flm2 = re.findall(flp2,i) #flm = first line mismatch   #flp = first line pattern
        flm3 = re.findall(flp3,i) #flm = first line mismatch   #flp = first line pattern
        ...
        slm = re.findall(slp,str(i)) #slm = second line match = slm     #slp = second line pattern 
        ...
        folm1 = re.findall(folp1,str(i))   #folp1 = fourth line of pattern normal # folm1 = fourth line of marks normal
        folm2 = re.findall(folp2,str(i))   #folp2 = fourth line of pattern mismatch1 101 line # folm1 = fourth line of marks mismatch
        folm3 = re.findall(folp3,str(i))  #folp3 = fourth line of pattern mismatch1 125 line # folm1 = fourth line of marks mismatch
